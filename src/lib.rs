// src/lib.rs
/*
 * Core library for AnimeProcessor
 */
...
#[derive(Debug)]
pub struct AnimeProcessorProcessor {
    verbose: bool,
    processed_count: usize,
}

impl AnimeProcessorProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting AnimeProcessor processing");
    
    let mut processor = AnimeProcessorProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = AnimeProcessorProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = AnimeProcessorProcessor::new(false);
